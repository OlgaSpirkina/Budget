...
app.post('/trainer', (req,res,next) => {
  ...
  /*
  let date, veggy, fruits, bread_pasta, chocolate, cereals, sql;
  date = req.body.date;
  veggy = req.body.veggy;
  fruits = req.body.fruits;
  bread_pasta = req.body.bread_pasta;
  chocolate = req.body.chocolate;
  cereals = req.body.cereals;
  sql = `INSERT INTO food (date, veggy, fruits, bread_pasta, chocolate, cereals) VALUES ("${date}", "${veggy}", "${fruits}", "${bread_pasta}", "${chocolate}", "${cereals}")`;
*/
